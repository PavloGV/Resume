...
% Work Experience
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	& \textbf{Work Experience} & & \textbf{COSMOS California Summer School for Mathematics \& Science} & \textbf{Summer 2018} & \\
	& & & \text{Embedded Programming Teacher} & &\\
	& & & \textbf{Inboard Technologies} & \textbf{Summer 2017} & \\
	& & & \text{Electrical Engineer Intern} & &\\
\end{flalign*}
\end{document}
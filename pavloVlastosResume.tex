...
\def \middleColSpace    {0.71}       % Space for middle column
...
\begin{document} 
    ...
    \begin{minipage}[t]{\bigMiddleColSpace\linewidth}
        \noindent Robotics engineer capable of software developement for embedded systems and control theory. Positive work mentality, strong communication, and teamwork skills. Passionate about solving problems.
    \end{minipage}
